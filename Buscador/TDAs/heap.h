...
/* Prototipo de función de comparación que se le pasa como parámetro a 
 * las diversas funciones del heap.
 ...
 * prioridad. Si se desea un min-heap, alcanza con invertir la función
 * de comparación.
 */
 ...
 * a utilizar. Devuelve un puntero al heap, el cual debe ser destruido 
 * con heap_destruir(). 
 */
 ...
 * Post: se llamó a la función indicada con cada elemento del heap. 
 * El heap dejó de ser válido. */
...
//Compara dos valores externos mediante la funcion de comparacion
